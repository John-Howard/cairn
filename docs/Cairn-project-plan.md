...
| 2i Asset intake wizard *(added 2026-07 — `Cairn-2i-asset-intake-plan.md`)* | Guided asset question set over a generalised (`question_set`-discriminated) intake engine: the discriminator and per-set reseed mechanics (2i.1), the `/intake/assets` wizard and seeded *IAR Question Set v0.1* (2i.2), gaps-queue and asset-detail curation surfacing (2i.3). **Built 2026-07-30.** |

**Deliverables:** working Cairn application (FRS pack), incrementally through 2a→2f; IAR extension 2g–2i.
